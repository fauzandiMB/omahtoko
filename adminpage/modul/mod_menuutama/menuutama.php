...
<h3 class='box-title'>
<input type=button class='btn btn-primary btn' value='Tambah Menu Utama' 
    ...
    <table id='example1' class='table table-bordered table-striped'>
          ...
          <td class='center'>Nama Menu</td>
          <td class='left'>link</td>
          <td class='left'>Urutan</td>
          <td class='center'>Status Aktif</td>
          <td class='center'>Letak</td>
          <td class='center'>Aksi</td></tr></thead><tbody>";
          
    $tampil=mysql_query("SELECT * FROM menuutama");
    $no=1;
    while ($r=mysql_fetch_array($tampil)){
       echo "<tr><td class='center' width='25'>$no</td>
             ...
             <td class='center'>
		         <a class='btn btn-info' href='?module=menuutama&act=editmenuutama&id=$r[id_main]'>
										<i class='icon-edit icon-white'></i>  
										Edit                                            
									</a>
									<a class='btn btn-danger' href='$aksi?module=menuutama&act=hapus&id=$r[id_main]'>
                        ...
                        <div class='col-md-12'>
                            <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Tambah <small>Menu Utama</small></h3>
                                    <!-- tools box -->
                                ...
                                <div class='form-group'>
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <input type='text' class='form-control' name='link' placeholder='URL Link ...'/>
                                        </div>
                                        <div class='form-group'>
                                            <label>Urutan</label>
                                            <input type='text' class='form-control' name='urutan' placeholder='Urutan Menu ...'/>
                                        </div>
                                        <div class='form-group'>
                                        ...
                                        <label>Penempatan Menu</label>
                                            <div class='radio'>                                            
                                                <label>
                                                    ...
                                                    Public, Maka Menu Hanya muncul di halaman Website
                                                </label>
                                            </div>
                                            <div class='radio'>
                                                <label>
                                                    <input type='radio' name='lokasi' id='optionsRadios2' value='Admin'>
                                                   Admin, Maka Menu Hanya muncul di halaman Admin
                                                </label>
                                            </div>                                            
                                        </div>
                                        <div class='form-group'>
                                        <label>Hak Akses</label>
                                            <div class='radio'>                                            
                                                <label>
                                                    ...
                                                    User, Maka User dan Admin dapat mengakses menu, Catatan : Hanya Berfungsi di Halaman Admin Saja
                                                </label>
                                            </div>
                                            <div class='radio'>
                                                <label>
                                                    <input type='radio' name='hakakses' id='optionsRadios2' value='Admin'>
                                                    Admin, Maka Hanya Admin yang dapat mengakses menu, Catatan : Hanya Berfungsi di Halaman Admin Saja
                                                </label>
                                            </div>                                            
                                        </div>
                                         <div class='form-group'>
                                            <label>Icon</label>
                                            <input type='text' class='form-control' name='icon' placeholder='Contoh : fa fa-dashboard'/>
                                            <p class='help-block'>Catatan : Ini hanya digunakan untuk Halaman Admin saja, <i>Ketikkan Tipe Icon, untuk daftar icon dapat dilihat di Bawah Tombol <b>Simpan</b></i></p>
                                        </div>
                                        <div class='form-group'>
...
<section class='content'>
                    ...
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Daftar <small>Icon</small></h3>
                                    <!-- tools box -->
                                    <div class='pull-right box-tools'>
                                        <button class='btn btn-info btn-sm' data-widget='collapse' data-toggle='tooltip' title='Collapse'><i class='fa fa-minus'></i></button>
                                        <button class='btn btn-info btn-sm' data-widget='remove' data-toggle='tooltip' title='Remove'><i class='fa fa-times'></i></button>
  ...
  case "editmenuutama":
    $edit=mysql_query("SELECT * FROM menuutama WHERE id_main='$_GET[id]'");
    ...
    echo "<section class='content'>
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='box box-info'>
                                <div class='box-header'>
                                    <h3 class='box-title'>Edit <small>Menu Utama</small></h3>
                                    <!-- tools box -->
                                    <div class='pull-right box-tools'>
                                        <button class='btn btn-info btn-sm' data-widget='collapse' data-toggle='tooltip' title='Collapse'><i class='fa fa-minus'></i></button>
                                        <button class='btn btn-info btn-sm' data-widget='remove' data-toggle='tooltip' title='Remove'><i class='fa fa-times'></i></button>
          ...
          <div class='form-group'>
                                        ...
                                        <div class='form-group'>
                                            <label>Urutan</label>
                                            <input type='text' class='form-control' name='urutan' value='$r[urutan]'/>
                                        </div>
                                        <div class='form-group'>
                                         <label>Status Menu</label>
                                            <div class='radio'>";
    	...
    	echo "  <div class='radio'>                                            
                                                <label>
                                                    <input type='radio' name='lokasi' id='optionsRadios1' value='Public'>
                                                    Public, Maka Menu Hanya muncul di halaman Website
                                                </label>
                                            </div>
                                            <div class='radio'>
                                                <label>
                                                    <input type='radio' name='lokasi' id='optionsRadios2' value='Admin' checked>
                                                   Admin, Maka Menu Hanya muncul di halaman Admin
                                                </label>";
                                                 }
                                                 echo "  </div>                                            
    	...
    	echo "<label>
                                                    <input type='radio' name='hakakses' id='optionsRadios1' value='User'>
                                                    User, Maka User dan Admin dapat mengakses menu, Catatan : Hanya Berfungsi di Halaman Admin Saja
                                                </label>
                                            </div>
                                            <div class='radio'>
                                                <label>
                                                    <input type='radio' name='hakakses' id='optionsRadios2' value='Admin' checked>
                                                    Admin, Maka Hanya Admin yang dapat mengakses menu, Catatan : Hanya Berfungsi di Halaman Admin Saja
                                                </label>";
                                              }
                                              echo "
